...
- `StoatworksAbout.h` and `ATTRIBUTIONS.md` are GENERATED by
  stoatworks-backend's `sync-about.py` and `sync-attributions.py`; never edit
  them here. The About block is five entries (text plus User guide, Project
